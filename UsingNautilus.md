...
```shell
curl -H 'Content-Type: application/json' -X GET http://54.221.146.81:3000/health_check

curl -H 'Content-Type: application/json' -X GET http://54.221.146.81:3000/get_attestation

curl -H 'Content-Type: application/json' -d '{"payload": { "location": "San Francisco"}}' -X POST http://54.221.146.81:3000:3000/process_data
```
